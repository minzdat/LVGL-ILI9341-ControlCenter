...
extern int slider_value_mq2; // Biến lưu giá trị slider 2
extern int slider_value_temp; // Biến lưu giá trị slider 1
extern void ui_slider_event_cb(lv_event_t *e);
extern bool switch1_state;
void switch_event_handler(lv_event_t *e);
// Biến toàn cục thời gian
extern int hoursTFT;
extern int minutesTFT;
extern int secondsTFT;
extern void update_clock(lv_obj_t *hour_img, lv_obj_t *minute_img, lv_obj_t *second_img, int hour, int minute, int second);
extern void updateDisplayTime(int* hours, int* minutes, int* seconds);
