...
lv_obj_t * label_ui_Slider1;
lv_obj_t * label_ui_Slider2;
...
void ui_Screen4_screen_init(void)
{
    ...
    lv_label_set_text(ui_Label13, "MQ-2");
    ...
    label_ui_Slider1 = lv_label_create(ui_TabPage2);
    lv_obj_set_width(label_ui_Slider1, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(label_ui_Slider1, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(label_ui_Slider1, 20);
    lv_obj_set_y(label_ui_Slider1, -30);
    lv_obj_set_align(label_ui_Slider1, LV_ALIGN_CENTER);
    lv_label_set_text(label_ui_Slider1, "0");
    lv_obj_add_event_cb(ui_Slider1, ui_slider_event_cb, LV_EVENT_VALUE_CHANGED, label_ui_Slider1);
    ...
    label_ui_Slider2 = lv_label_create(ui_TabPage2);
    lv_obj_set_width(label_ui_Slider2, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(label_ui_Slider2, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(label_ui_Slider2, 20);
    lv_obj_set_y(label_ui_Slider2, 10);
    lv_obj_set_align(label_ui_Slider2, LV_ALIGN_CENTER);
    lv_label_set_text(label_ui_Slider2, "0");
    lv_obj_add_event_cb(ui_Slider2, ui_slider_event_cb, LV_EVENT_VALUE_CHANGED, label_ui_Slider2);
